...
public class PassPercentageCalculator {
    public static void main(String[] args) {
        ...
        // Simulate scores for 100 students and 7 subjects (you can replace this with actual data)
        ...
        for (int student = 0; student < 100; student++) {
            ...
            for (int subject = 0; subject < 7; subject++) {
                studentScores[subject] = (int) (Math.random() * 101); // Generate a random score between 0 and 100
                totalCount[subject]++; // Increment total count for the subject
                if (studentScores[subject] >= 50) {
